...
public class Player : MovingObject
{
                ...
                if (hit.transform != null)
                {
                    switch (hit.transform.gameObject.tag)
                    {
                        ...
                        case "Enemy":
                            ...
                            break;
                        case "Ayuda":
                            canMove = AttemptMove<AyudaJugador>(horizontal, vertical);
                            break;
                    }
    ...
    protected override void OnCantMove<T>(T component)
    {
        ...
        else if (typeof(T) == typeof(AyudaJugador))
        {
            AyudaJugador blockingObj = component as AyudaJugador;
            blockingObj.SpawnAlrededorJugador();
        }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.tag == "RecolocarEnemigo")
        {
            GameManager.instance.InvocarRecolocarEnemig();
            Destroy(other.gameObject);
        }
        else if (other.tag == "ayudaJugador")
        {
